...
import 'package:untitled3/bar%20graph/bar_graph.dart';
    ...
    return Consumer<ExpenseData>(
             builder : (context,value,child) => Column(
               children: [
                 Padding(
                   ...
                   child: Row(
                     children: [
                       ...
                       Text(' \$${calculateWeekTotal(value, sunday, monday,
                 ...
                 SizedBox(
                   height: 200,
                   child: MyBarGraph(maxY:calculateMax(value, sunday, monday, tuesday,
